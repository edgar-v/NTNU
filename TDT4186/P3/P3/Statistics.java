...
public class Statistics
{
    ...
    public long cpuQueueLargestSize = 0;
    public long cpuQueueLengthTime = 0;
    public long ioQueueLargestSize = 0;
	...
	public void printReport(long simulationLength) {
        ...
        System.out.println("Average throughput (processes per second): " + 
			(float)nofCompletedProcesses/simulationLength*1000);
        System.out.println();
        ...
        System.out.println("Fraction of CPU time spent processing: "+ 
			(float)timeSpentCPU/simulationLength*100 + "%");
        System.out.println("Total CPU time spent waiting: " + 
			(simulationLength-timeSpentCPU)+ "ms");
        System.out.println("Fraction of CPU time spent waiting: " + 
			(float)(simulationLength-timeSpentCPU)/simulationLength*100 + "%");
        System.out.println();
        ...
        System.out.println("Largest occuring I/O queue length: " + ioQueueLargestSize);
