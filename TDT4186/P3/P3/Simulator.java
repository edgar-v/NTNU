...
public class Simulator implements Constants
{
	...
	public Simulator(Queue memoryQueue, Queue cpuQueue, Queue ioQueue, long memorySize, long maxCpuTime, long avgIoTime, long simulationLength, long avgArrivalInterval, Gui gui) {
        ...
        this.cpu = new CPU(cpuQueue, statistics, gui, eventQueue, maxCpuTime);
	...
	private void flushMemoryQueue() {
		...
		while(process != null) {
            ...
            this.cpu.addToQueue(process, this.clock);
	...
	private void endIoOperation() {
        Process finishedIOOperation = this.io.endIOOperation();
        this.io.performIO(this.clock);
        this.cpu.addToQueue(finishedIOOperation, this.clock);
	}
